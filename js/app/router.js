define(function (require) {
    ...
    return Backbone.Router.extend({
        ...
        getWelcome: function () {
            ...
            require(["app/views/Welcome"], function (Welcome) { 
                Useful.correctView(that.body);
                slider.slidePage(new Welcome({message_count:that.message_count}).$el);               
             });
        },
                
        getJunior: function () {
            
            require(["app/views/Junior"], function (Junior) { 
                Useful.correctView(that.body);
                slider.slidePage(new Junior({message_count:that.message_count}).$el);               
             });
        },
                
        getSenior: function () {
            
            require(["app/views/Senior"], function (Senior) { 
                Useful.correctView(that.body);
                slider.slidePage(new Senior({message_count:that.message_count}).$el);               
             });
        },
                
        getSport: function () {
            
            require(["app/views/Sport"], function (Sport) { 
                Useful.correctView(that.body);
                slider.slidePage(new Sport({message_count:that.message_count}).$el);               
             });
        },
                
        getOther: function () {
            
            require(["app/views/Other"], function (Other) { 
                Useful.correctView(that.body);
                slider.slidePage(new Other({message_count:that.message_count}).$el);               
             });
        },
                
        getTransition: function () {
            
            require(["app/views/Transition"], function (Transition) { 
                Useful.correctView(that.body);
                slider.slidePage(new Transition({message_count:that.message_count}).$el);               
             });
        },
